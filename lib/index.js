 ...
 *   @property {Boolean} usePartialsAbsolutePath (optional)
 * @return {Function}
 */
function plugin(opts){
  ...
  var usePartialsAbsolutePath = opts.usePartialsAbsolutePath || false;
  ...
  return function(files, metalsmith, done){
    ...
    if (partials) {
      if (typeof partials === 'string') {
        params.partials = readPartials(partials, partialExtension, dir, metalsmith, usePartialsAbsolutePath);
      } else {
