 ...
 * @return {Object}
 */
function readPartials(partialsPath, partialExtension, layoutsPath, metalsmith, usePartialsAbsolutePath) {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    var partialPath = usePartialsAbsolutePath ? partialAbs : path.relative(layoutsAbs, partialAbs);
